...
class ExecTimePredictor:
    def __init__(self):
        ...
        self.artifact_dir = os.path.join(os.path.dirname(__file__), 'artifacts', 'ffnn_best_original')
    ...
    def update_csv(self, csv_file='models_comparison_RES.csv'):
        ...
        # Save columns
        col_name = "FFNN_BEST_ORIGINAL"
        err_name = "FFNN_BEST_ORIGINAL_%ERROR"
...
if __name__ == "__main__":
    ...
    # Update CSV after training or loading artifacts
