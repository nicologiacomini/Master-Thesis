...
def predict_execution_time(n_nodes, msize, bsize, model='both', dataset='both'):
    """
    Predict COMPSs execution time using ML models trained with K-Fold Cross-Validation
...
def main():
    ...
    print("=" * 70)
    print("Test 4: K-Fold Cross-Validation (5 Folds)")
    print("=" * 70)
    print(f"\nInput parameters:")
    ...
    print("\nNote: Models trained with 5-fold cross-validation for robust performance")
    ...
    print("  ✓ Reduced variance in predictions")
